...
add_action(
	...
	static function ( $registry ) {
		$registry->register(
			array(
				'id'       => 'star_rating',
				'title'    => __( 'Star Rating', 'loom' ),
				'icon'     => 'star-filled',
				'category' => 'basic',
				'controls' => array(
					'rating' => array( 'type' => 'range', 'label' => __( 'Rating', 'loom' ), 'default' => 4, 'min' => 0, 'max' => 5, 'section' => 'content' ),
					'label'  => array( 'type' => 'text', 'label' => __( 'Label', 'loom' ), 'default' => '', 'section' => 'content' ),
					'color'  => array( 'type' => 'color', 'label' => __( 'Star color', 'loom' ), 'default' => '#f59e0b', 'section' => 'style' ),
					'size'   => array( 'type' => 'range', 'label' => __( 'Star size (px)', 'loom' ), 'default' => 20, 'min' => 14, 'max' => 40, 'section' => 'style' ),
				),
...
function loom_render_star_rating( $s ) {
	...
	$out .= '<span class="loom-star-rating-stars" aria-label="' . esc_attr( sprintf( /* translators: %d: rating out of 5. */ __( '%d out of 5', 'loom' ), $rating ) ) . '">';
	for ( $i = 1; $i <= 5; $i++ ) {
