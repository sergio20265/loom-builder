...
add_action(
	...
	static function ( $registry ) {
		$registry->register(
			array(
				'id'       => 'icon_box',
				'title'    => __( 'Icon Box', 'loom-builder' ),
				'icon'     => 'star-filled',
				'category' => 'basic',
				'controls' => array(
					'icon'      => array(
						'type'    => 'text',
						'label'   => __( 'Dashicon name', 'loom-builder' ),
						'default' => 'star-filled',
						'section' => 'content',
					),
					'title'     => array(
						...
						'default' => __( 'Icon box title', 'loom-builder' ),
						'section' => 'content',
					),
					'text'      => array(
						'type'    => 'textarea',
						'label'   => __( 'Text', 'loom-builder' ),
						'default' => __( 'Describe this feature in a sentence or two.', 'loom-builder' ),
						'section' => 'content',
					),
					'link'      => array(
						'type'    => 'url',
					...
					'iconSize'  => array( 'type' => 'range', 'label' => __( 'Icon size (px)', 'loom-builder' ), 'default' => 40, 'min' => 16, 'max' => 120, 'section' => 'content' ),
