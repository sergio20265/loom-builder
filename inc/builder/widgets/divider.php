				...
				'controls' => array(
					'style'     => array(
						...
						'options' => array(
							...
							'dashed' => __( 'Dashed', 'loom-builder' ),
							'dotted' => __( 'Dotted', 'loom-builder' ),
							'double' => __( 'Double', 'loom-builder' ),
						),
						'section' => 'content',
					),
					'width'     => array( 'type' => 'range', 'label' => __( 'Width (%)', 'loom-builder' ), 'default' => 100, 'min' => 10, 'max' => 100, 'section' => 'content' ),
					'thickness' => array( 'type' => 'range', 'label' => __( 'Thickness (px)', 'loom-builder' ), 'default' => 1, 'min' => 1, 'max' => 12, 'section' => 'content' ),
					'gap'       => array( 'type' => 'range', 'label' => __( 'Spacing (px)', 'loom-builder' ), 'default' => 16, 'min' => 0, 'max' => 80, 'section' => 'content' ),
					'align'     => array(
						'type'    => 'select',
					...
					'color'     => array( 'type' => 'color', 'label' => __( 'Color', 'loom-builder' ), 'default' => '#e5e7eb', 'section' => 'style' ),
				),
