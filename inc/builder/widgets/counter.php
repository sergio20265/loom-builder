...
add_action(
	...
	static function ( $registry ) {
		$registry->register(
			array(
				'id'       => 'counter',
				'title'    => __( 'Counter', 'loom' ),
				'icon'     => 'chart-bar',
				'category' => 'basic',
				'controls' => array(
					'number'   => array( 'type' => 'number', 'label' => __( 'Number', 'loom' ), 'default' => 100, 'section' => 'content' ),
					'prefix'   => array( 'type' => 'text', 'label' => __( 'Prefix', 'loom' ), 'default' => '', 'section' => 'content' ),
					'suffix'   => array( 'type' => 'text', 'label' => __( 'Suffix', 'loom' ), 'default' => '+', 'section' => 'content' ),
					'label'    => array( 'type' => 'text', 'label' => __( 'Label', 'loom' ), 'default' => __( 'Happy clients', 'loom' ), 'section' => 'content' ),
					'duration' => array( 'type' => 'range', 'label' => __( 'Animation duration (ms)', 'loom' ), 'default' => 2000, 'min' => 500, 'max' => 5000, 'section' => 'content' ),
					'align'    => array(
						'type'    => 'select',
					...
					'color'    => array( 'type' => 'color', 'label' => __( 'Number color', 'loom' ), 'default' => '#111111', 'section' => 'style' ),
					'size'     => array( 'type' => 'range', 'label' => __( 'Number size (px)', 'loom' ), 'default' => 48, 'min' => 20, 'max' => 96, 'section' => 'style' ),
				),
